...
I, Marko Stankovic use the ResNet1d_wang model in the context of my bachelor thesis and this module is necessary for it to work.
"""
...
class basic_conv1d(nn.Sequential):
    ...
    def __init__(self, filters=[128,128,128,128], kernel_size=3, stride=2, dilation=1, pool=0, pool_stride=1, squeeze_excite_reduction=0, num_classes=2, input_channels=12, act="relu", bn=True, headless=False,split_first_layer=False,drop_p=0.,lin_ftrs_head=None, ps_head=0.5, bn_final_head=False, bn_head=True, act_head="relu", concat_pooling=True):
        ...
        for i in range(len(filters)):
            ...
            # Ändere hier die Anzahl der Eingangskanäle entsprechend der Daten
